...
<body style="background:#f8f8f8;">
	...
	<a href="javascript:void(0)"> <button type="button" class="button"style="margin-top:30px;background: #FF5F74;color:#fff;" onclick="loginout()" >退出登录</button></a>
	<ul class="mui-table-view ul">
		<li class="mui-table-view-cell mui-collapse-content"><p class="li">联系客服</p> </li>
	    <li class="mui-table-view-cell mui-collapse-content" ><p class="li">当前版本</p><p class="right">v 3.1.0</p> </li>
	</ul>
