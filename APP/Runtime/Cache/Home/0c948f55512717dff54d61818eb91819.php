...
<html>
	...
	<!--
	<body style="background: url('../Public/home/wap/images/logo.png')/*#f8f8f8*/;background-size:50%;    background-position: 50% 50%;background-repeat: no-repeat;">
	-->
	<body style="background: #f8f8f8;background-size:50%;    background-position: 50% 50%;background-repeat: no-repeat;">
		...
		<div class="mui-content">
			<div id="slider" class="mui-slider mui-fullscreen">
				<div id="sliderSegmentedControl" class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
					<div class="mui-scroll" style="color: #ececec;">
						<a class="mui-control-item headlist" id="itemmobilea" href="javascript:void(0);">
							待收款
						</a>
						<a class="mui-control-item mui-active headlist" id="itemmobileb"  href="javascript:void(0);">
							已收款
						</a>
						...
						<div class="mui-scroll-wrapper">
							...
							<?php if(is_array($slist)): foreach($slist as $key=>$info): ?><ul class="mui-table-view ullist">
									<li class="mui-table-view-cell mui-collapse-content">
										<p class="dingdan">支付类型：<?php echo getclass($info['class']);?></p>
										<p class="dingdan">卖出资产：<?php echo ($info["price"]); ?> USDT</p>
										<p class="dingdan">收款金额：<?php echo ($info["pricermb"]); ?> RMB</p>
										<p class="dingdan">状态：<?php echo getstatus($info['status']);?></p>
									</li>
				...
				<div class="mui-slider-group"  id="item2mobile"  style="display:block;">
					<div  class="mui-slider-item mui-control-content">
						<div class="mui-scroll-wrapper">
							<div class="mui-scroll">
