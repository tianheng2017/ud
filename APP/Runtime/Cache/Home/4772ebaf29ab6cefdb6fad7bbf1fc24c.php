...
<body style="background: #f8f8f8;" class="mui-ios mui-ios-11 mui-ios-11-0">
	...
	<div style="background: #fff;height: 650px;margin-top: 55px;">
		<form class="mui-input-group" name="AddUser" action="<?php echo U('User/set_info');?>" id="registerForm"  style="position: absolute;  top: 65px; height: 0px; width: 80%; left: 0px; right: 0px; margin: auto; ">
			...
			<div class="mui-input-row" style="height: 2.5em; border-radius:30px;background-color:#fff; margin-bottom: 30px;border:1px solid #ccc;">
				<img src="../Public/home/wap/images/mima.png" style="position: absolute; width: 35px; margin-left: 15px; margin-top: 4px;">
				<input type="text" id="usdt_erc20"  name="usdt_erc20" value="<?php echo ($list['usdt_erc20']); ?>"  <?php if($list['rz_st']==1){echo "readonly='readonly'";}?>  style=" color: #000; margin-left: 50px; font-size: 0.9em; font-family: &#39;微软雅黑&#39;;" placeholder="USDT_ERC20收款地址">
			</div>
			<div class="mui-input-row" style="height: 2.5em; border-radius:30px;background-color:#fff; margin-bottom: 30px;border:1px solid #ccc;">
				<img src="../Public/home/wap/images/mima.png" style="position: absolute; width: 35px; margin-left: 15px; margin-top: 4px;">
				<input type="text" id="usdt_omini"  name="usdt_omini" value="<?php echo ($list['usdt_omini']); ?>"  <?php if($list['rz_st']==1){echo "readonly='readonly'";}?>  style=" color: #000; margin-left: 50px; font-size: 0.9em; font-family: &#39;微软雅黑&#39;;" placeholder="USDT_OMINI收款地址">
			</div>
			<div class="mui-input-row" style="height: 2.5em; border-radius:30px;background-color:#fff; margin-bottom: 30px;border:1px solid #ccc;">
				<img src="../Public/home/wap/images/mima.png" style="position: absolute; width: 35px; margin-left: 15px; margin-top: 4px;">
