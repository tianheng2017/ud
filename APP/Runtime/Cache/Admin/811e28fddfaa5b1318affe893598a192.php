...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted">匹配成功支付中</li>
                                              ...
                                              <thead>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;color:#3cd7d1;"><?php if($v['status']==2){echo '待付款';}?></td>
															<!--
															<td style="font-size:12px;">
																<a href="<?php echo U('Roborder/paypage',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">立即支付 |</a>
																<a href="<?php echo U('Roborder/cancel',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">取消订单 |</a>
																<a href="<?php echo U('Roborder/delorder',array('id'=>$v['id']));?>"  style="font-size:12px;cursor:pointer;">删除订单</a>
															</td>	
															-->
