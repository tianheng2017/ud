...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        <ul class="breadcrumb">
            ...
            <li class="text-muted">会员管理 /  余额锁定</li>
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/moneyts/userid/23.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
											...
											<div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="money" value="<?php echo ($info["money"]); ?>" readonly="readonly" placeholder="余额">
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">锁定金额：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="smoney" value="<?php echo ($info["smoney"]); ?>" readonly="readonly" placeholder="锁定金额">
                                                </div>
                                            </div>
											...
											<div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="radio" id="typev" name="typev" value="1" checked> 余额锁定
													<input type="radio" id="typev" name="typev" value="2"> 解锁金额
                                                </div>
                                            </div>
											...
											<div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="moneyt" value="" placeholder="金额">
                                                </div>
                                            </div>
                                        <div class="form-group"></div>
