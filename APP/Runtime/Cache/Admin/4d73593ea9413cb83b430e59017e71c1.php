        ...
        <div class="tab-content ct-tab-content" >
            ...
            <div role="tabpanel" class="tab-pane fade in active" id="home">
                <div class="dashboard clearfix">
                    <div class="col-xs-12 col-sm-3 col-lg-3 ct-update">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background:#386a30;color:#ccc;">
                                <div class="update pull-right"></div>
                                <i class="fa fa-cog"></i> 会员数据
                            </div>
                            <div class="panel-body"  style="height:300px;background:#5a8a51;">
                                <table class="table table-condensed">
                                    <tbody>
                                        <tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">今日新增会员：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($user_count); ?></td>
                                        </tr>
                                        <tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">全网总会员数：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($user_total); ?></td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">总充值金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($resum); ?> USDT</td>
                                        </tr>
										
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">今日总充值金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($resumj); ?> USDT</td>
                                        </tr>
										
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">总提现金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($wisum); ?> USDT</td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">全网总余额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($countmoney); ?> USDT</td>
                                        </tr>
										<tr>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">全网总佣金：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($sumyj); ?> USDT</td>
                                        </tr>
										<tr>
					...
					<div class="col-xs-12 col-sm-3 col-lg-3 ct-update">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background:#386a30;color:#ccc;">
                                <div class="update pull-right"></div>
                                <i class="fa fa-cog"></i> 订单数据统计
                            </div>
                            <div class="panel-body"  style="height:300px;background:#5a8a51;">
                                <table class="table table-condensed">
                                    <tbody>
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">已完成订单量：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($finishorder_count); ?></td>
                                        </tr>
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">已完成订单金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($finishorder_money); ?> USDT</td>
                                        </tr>
										<!--
                                        <tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">已匹配订单量：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($sucorder_count); ?></td>
                                        </tr>
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">已匹配订单金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($sucorder_money); ?></td>
                                        </tr>
										
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">后台发布未匹配订单量：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($dd_orderm_admin); ?></td>
                                        </tr>
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">后台发布未匹配订单金额：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($dd_ordern_admin); ?></td>
                                        </tr>
										<tr>
                                            <td style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;">会员发布空匹配单量：</td>
                                            <td  style="font-size:12px;color:#ccc;border-top:none;border-bottom:1px dashed #ccc;"><?php echo ($nollorder_count); ?></td>
                                        </tr>
                                       -->
                                    </tbody>
                                </table>
