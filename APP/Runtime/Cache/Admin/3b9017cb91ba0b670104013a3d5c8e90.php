                                              ...
                                              <thead>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;"><?php echo date('Y-m-d H:i:s',$v['reg_date']);?></td>
															<td style="font-size:12px;"><?php echo getSjuser($v['pid']);?></td>
                                                            <td style="font-size:12px;"><?php echo $v['truename']?:'无';?></td>
                                                            <td style="font-size:12px;"><?php echo $v['usercard']?:'无';?></td>
                                                            <td style="font-size:12px;"><?php echo get_real($v['real']);?></td>
															<td style="font-size:12px;">
																<a href="<?php echo U('User/regmanagedo',array('userid'=>$v['userid'], 'type'=>1));?>" style="font-size:12px;cursor:pointer;">通过 ||</a>
																<a href="<?php echo U('User/regmanagedo',array('userid'=>$v['userid'], 'type'=>2));?>" style="font-size:12px;cursor:pointer;">拒绝 ||</a>
																<a href="<?php echo U('User/regmanagedo',array('userid'=>$v['userid'], 'type'=>3));?>" style="font-size:12px;cursor:pointer;">删除账号</a>
															</td>
