                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">USDT数量</th>
													<th style="font-size:12px;">收款RMB金额</th>
                                                    <th style="font-size:12px;">匹配时间</th>
                                                    <th style="font-size:12px;">完成时间</th>
													
													<th style="font-size:12px;">支付审查</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;">
																<?php if($v['class'] ==1){ echo '微信收款'; }elseif($v['class'] ==2){ echo '支付宝收款'; }elseif($v['class'] ==3){ echo '银行收款'; }elseif($v['class'] ==6){ echo 'USDT收款'; } ?>
															</td>
															<td style="font-size:12px;"><?php echo $v['price'];?></td>
															<td style="font-size:12px;"><?php echo $v['pricermb'];?></td>
															...
															<td style="font-size:12px;">
															<?php if($v['hasfalistate']==-1){echo '未审查';}?>
															<?php if($v['hasfalistate']==1){echo '已审查';}?>
															</td>
															
															
															<td style="font-size:12px;color:#ff354f;"><?php if($v['status']==4){echo '未支付';}?></td>
															
															<td style="font-size:12px;">
																<a href="<?php echo U('Roborder/fhmed',array('id'=>$v['id']));?>"  style="font-size:12px;cursor:pointer;">返还额度</a>
																<a href="<?php echo U('Roborder/nofhmed',array('id'=>$v['id']));?>"  style="font-size:12px;cursor:pointer;color:red;">不返还</a>
															</td>	
