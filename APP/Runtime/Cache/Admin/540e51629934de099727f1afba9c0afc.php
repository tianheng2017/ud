            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/adminrecharge/userid/22.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
											...
											<div class="form-group item_title ">
                                                <label class="left control-label">资产余额：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="money" value="<?php echo ($info["money"]); ?>" readonly="readonly" placeholder="余额">
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">充币类型：</label>
                                                <div class="right">
                                                    <input type="radio" name="typev" value="1" checked> ERC20充币
													<input type="radio" name="typev" value="2"> OMINI充币
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">充币数量：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="moneyt" value="" placeholder="数量">
                                                </div>
                                            </div>
                                        <div class="form-group"></div>
