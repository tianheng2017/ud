                            ...
                            <div class="col-xs-12" >
                                ...
                                <div class="form-type-list">
                                   ...
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                    ...
                                    <div class="form-group item_config[WEB_SITE_TITLE] " style="display:none;">
                                    ...
                                    <div class="form-group item_config[WEB_SITE_TITLE] " style="display:none;">
                                        <label class="left control-label">USDT抢单佣金比：</label>
                                        <div style="width:50%" class="input-group">
                                            <input type="text" name="qd_usdtyj" class="form-control" value="<?php echo ($info["qd_usdtyj"]); ?>" placeholder="USDT抢单佣金比例：如30%要写成0.3"/>
									...
									<div class="form-group item_config[WEB_SITE_TITLE] " style="display:none;">
                                        <label class="left control-label">佣金加成：</label>
                                         <div style="width:50%" class="input-group">
                                            <input type="text" name="qd_yjjc" class="form-control" value="<?php echo ($info["qd_yjjc"]); ?>" placeholder="如加成0.1%，写成0.001"/>
                                   ...
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
									...
									USDT充币地址设置<hr style="margin-top: 0px;width: 100%">

                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">erc20充值地址：</label>
                                        <div style="width:50%" class="input-group">
                                            <input type="text" name="erc20_address" class="form-control" value="<?php echo ($info["erc20_address"]); ?>" placeholder="erc20充值地址"/>

                                        </div>
                                    </div>

                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">omini充值地址：</label>
                                        <div style="width:50%" class="input-group">
                                            <input type="text" name="omini_address" class="form-control" value="<?php echo ($info["omini_address"]); ?>" placeholder="omini充值地址"/>

                                        </div>
                                    </div>
									<div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">手控实时行情：</label>
                                        <div style="width:50%" class="input-group">
                                            <input type="text" name="handcoinprice" class="form-control" value="<?php echo ($info["handcoinprice"]); ?>" placeholder="手控实时行情（设置 0 时为不控）"/>
											（设置 0 时为不控）
                                        </div>
                                    </div>
