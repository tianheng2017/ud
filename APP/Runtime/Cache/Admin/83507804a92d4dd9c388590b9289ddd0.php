                                ...
                                <div class="col-xs-12 col-sm-12 clearfix" style="margin-bottom:20px;padding-top:0px;padding-bottom:10px;">
                                            ...
                                            <div class="form-group right">
												...
												<div style="float:left;width:10%;" class="input-group search-form" style="">
                                                    ...
                                                    <input type="submit" value="金额排序" style="margin-left: 50px;border:none;height:33px;width:80%;background:#2699ed;color:#ffffff;cursor:pointer;"/></button>
                                                </div>
												 </form>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;">提现方式</th>
                                                    <th style="font-size:12px;">提现日期</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;"><?php echo $v['way'];?></td>
															...
															<td style="font-size:12px;">
																<a href="<?php echo U('User/wiedit',array('id'=>$v['id'],'st'=>1));?>" style="font-size:12px;cursor:pointer;">提现 ||</a>
																<a href="<?php echo U('User/wiedit',array('id'=>$v['id'],'st'=>2));?>" style="font-size:12px;cursor:pointer;">退回 ||</a>
																<a href="<?php echo U('User/wiedit',array('id'=>$v['id'],'st'=>3));?>" style="font-size:12px;cursor:pointer;">删除</a>
															</td>
