                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size:12px;display:none;">收款金额</th>
													
													
													<th style="font-size:12px;">银行卡信息</th>
													
                                                    <th style="font-size:12px;">上传时间</th>
												...
												<tbody>
													...
													<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
															...
															<td style="font-size:12px;"><?php echo getclass($v['ewm_class']);?></td>
															<td style="font-size:12px;"><?php echo $v['ewm_acc'];?></td>
															<td style="font-size:12px;display:none;"><?php echo $v['ewm_price'];?></td>
															
															<td style="font-size:12px;text-align:left;">
																银行类型：<?php echo $v['yname'];?><br>
																开户分行：<?php echo $v['ynameson'];?><br>
																持卡人：<?php echo $v['yuname'];?><br>
																卡号：<?php echo $v['ycard'];?><br>
															</td>
															
															<td style="font-size:12px;"><?php echo date('Y-m-d H:i',$v['addtime']);?></td>
															
															<td style="font-size:12px;">
																<a href="<?php echo U('User/ewminfo',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">详情 ||</a>
																<a href="<?php echo U('User/delewm',array('id'=>$v['id']));?>" style="font-size:12px;cursor:pointer;">删除</a>
															</td>
