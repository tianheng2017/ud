...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        <ul class="breadcrumb">
            ...
            <li class="text-muted">二维码管理 /  二维码详情</li>
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/ewminfo/id/2.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                                <label class="left control-label">ID号：</label>
                                                <div class="right">
                                                    <input type="hidden" class="form-control input" readonly="readonly" name="userid" value="<?php echo ($info["id"]); ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" value="<?php echo ($info["uaccount"]); ?>" readonly="readonly" />
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">用户名：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="username" readonly="readonly" value="<?php echo ($info["uname"]); ?>" />
                                                </div>
                                            </div>
											 <div class="form-group item_title ">
                                                <label class="left control-label">二维码类型：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="username" readonly="readonly" value="<?php echo getclass($info['ewm_class']);?>" />
                                                </div>
                                            </div>
											 <div class="form-group item_title " style="display:none;">
                                                <label class="left control-label">收款金额：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="username" readonly="readonly" value="<?php echo ($info["ewm_price"]); ?>"/>
                                                </div>
                                            </div>

                                            <div class="form-group item_title ">
                                                <label class="left control-label">收款账号：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="mobile" readonly="readonly" value="<?php echo ($info["ewm_acc"]); ?>" />
                                                </div>
                                            </div>

											
											<div class="form-group item_title ">
                                                <label class="left control-label">收款图片地址：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="wx_no"  readonly="readonly" value="<?php echo ($info["ewm_url"]); ?>"/>
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">收款图片：</label>
                                                <div class="right">
                                                    <img src="<?php echo ($info["ewm_url"]); ?>" style="width:10%"/>
                                                </div>
                                            </div>

											
											<div class="form-group item_title ">
                                                <label class="left control-label">银行类型：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="ynameson" readonly="readonly" value="<?php echo ($info["ynameson"]); ?>" />
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">开户分行：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="yuname" readonly="readonly" value="<?php echo ($info["yuname"]); ?>" />
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">持卡人：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="yuname" readonly="readonly" value="<?php echo ($info["yuname"]); ?>" />
                                                </div>
                                            </div>
											<div class="form-group item_title ">
                                                <label class="left control-label">卡号：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input text" name="ycard" readonly="readonly" value="<?php echo ($info["ycard"]); ?>" />
                                                </div>
                                            </div>
